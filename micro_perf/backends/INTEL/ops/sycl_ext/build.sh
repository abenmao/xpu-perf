...
echo "Building add_rms_norm_dynamic_quant SYCL extension..."
icpx -fsycl -fsycl-targets=spir64_gen -Xs "-device bmg-g21" \
    -shared -fPIC -O3 -std=c++17 \
...
echo "Built: $SCRIPT_DIR/add_rms_norm_dynamic_quant_sycl.so"
ls -la add_rms_norm_dynamic_quant_sycl.so
