...
def abs_indices2indices_in_kvcache(
    ...
    real_block_idxs = block_table.view(-1).index_select(0, (abs_indices//block_size + torch.arange(0, b, device=abs_indices.device).view(b, 1, 1)*max_blocks_per_seq).view(-1))
